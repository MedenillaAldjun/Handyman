...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public class PostViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView postUsernames, postDate, postProducts, postAddress, postPrice, postLikecounts, postdisLikecounts, postFbname, postGcashname, postGcashnum,
        ...
        public void setPostdisLikecounts(int count){
            postLikecounts =  mView.findViewById(R.id.likecount_id1);
            postLikecounts.setText(count + " Likes");
        }
