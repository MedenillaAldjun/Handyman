...
import Adapter.PostAdapter3;
import Adapter.ResumeAdapter;
import Model.Post;
import Model.Resume;


public class Masonry extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_masonry, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.masonry_recview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mList = new ArrayList<>();
        adapter = new PostAdapter3(getContext(), mList);
        ...
        if(firebaseAuth.getCurrentUser() != null){
            query = firestore.collection("Masonry").orderBy("time", Query.Direction.DESCENDING);
