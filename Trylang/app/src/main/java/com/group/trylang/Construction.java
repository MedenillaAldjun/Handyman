...
public class Construction extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.construction_recview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mList = new ArrayList<>();
        adapter = new PostAdapter4(getContext(), mList);
        ...
        if(firebaseAuth.getCurrentUser() != null){
            query = firestore.collection("Construction").orderBy("time", Query.Direction.DESCENDING);
    ...
    @Override
    public void onStart() {
        firestore.collection("Construction")
